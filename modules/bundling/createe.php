...
$errors = [];
$produk_id = (int)get('produk_id', ''); // Support pre-selected from URL
$bundling_items = [];
...
if (isPost()) {
        ...
        foreach ($bundling_data as $item) {
            ...
            if ($bundle_id > 0 && $diskon > 0) {
                ...
                if (bundlingExists($produk_id, $bundle_id)) {
                    ...
                    $errors[] = 'Bundling dengan produk "' . ($product['nama'] ?? 'Unknown') . '" sudah ada';
                    break;
                }
                
                $valid_items[] = ['produk_id' => $bundle_id, 'diskon' => $diskon];
            }
        }
    }
    ...
    if (empty($errors) && !empty($valid_items)) {
        ...
        foreach ($valid_items as $item) {
            if (createBundling($produk_id, $item['produk_id'], $item['diskon'])) {
                $success_count++;
            }
        }
                        ...
                        <form method="POST" id="bundlingForm">
                            ...
                            <div class="mb-4">
                                ...
                                <div id="bundlingContainer">
                                    <!-- Bundling items will be added here -->
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="small mb-0">
                            ...
                            <li class="mb-2">Set diskon per produk bundling</li>
                            <li class="mb-2">Produk berbeda menguntungkan lebih</li>
                            <li class="mb-0">Preview total akan muncul otomatis</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="small">
                            ...
                            <strong>Bundling 3:</strong> Konsultasi 1 Jam (Diskon Rp 50.000)
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Add first bundling item by default
    addBundlingItem();
...
function updateAddButton() {
    ...
    if (currentItems >= maxBundling) {
        ...
        addBtn.innerHTML = '<i class="fas fa-check me-1"></i>Maksimal 5';
    } else {
