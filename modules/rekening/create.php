        ...
        <div class="dash-header mb-4 d-flex justify-content-between align-items-center">
            <div>
                ...
                <h1 class="dash-title mt-2 d-flex align-items-center gap-2">
                    <i class="fas fa-plus-circle text-primary"></i> Tambah Rekening
                </h1>
            </div>
        </div>
            ...
            <div class="col-lg-7">
                ...
                <div class="panel-editorial mb-4">
                    ...
                    <div class="row g-3 mb-2">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="custom_bank" class="form-control-editorial mt-2 d-none bg-light" id="customBank" placeholder="Ketik nama bank...">
                        </div>
                        <div class="col-md-6">
                ...
                <div class="panel-editorial mb-4" id="qr_upload_section" style="display: none; border-left: 4px solid #10B981;">
                    <h3 class="panel-title d-flex justify-content-between align-items-center">
                        ...
                        <span id="qris_status" class="badge bg-light text-muted border" style="font-size: 0.7rem;">Menunggu file...</span>
                    </h3>
                    ...
                    <div class="p-4 rounded-3 text-center border mb-3" style="background: #F9FAFB; border-style: dashed !important; position: relative; cursor: pointer;" onclick="document.getElementById('qr_image').click()">
                        ...
                        <h6 class="fw-bold text-dark mb-1">Upload Gambar QRIS</h6>
                        <p class="text-muted mb-0" style="font-size: 0.8rem;">Klik di sini untuk mengupload screenshot QRIS. Sistem akan mengekstrak datanya secara otomatis.</p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateMockup() {
        ...
        // Pengecekan apakah metode adalah QRIS
    ...
    document.getElementById('qr_image').addEventListener('change', function(e) {
        ...
        if (!file) {
            ...
            statusText.innerHTML = 'Menunggu file...';
        ...
        reader.onload = function(event) {
            ...
            img.onload = function() {
                ...
                if (code && code.data) {
                    ...
                    btnSubmit.disabled = false; // Tetap aktif agar user bisa save setelah paste manual
                }
            };
