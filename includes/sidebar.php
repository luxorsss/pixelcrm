...
<div class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-group">
            ...
            <div class="nav-item">
                <a href="<?= BASE_URL ?>modules/produk/" class="nav-link <?= isActive('', 'produk') ?>"
                    onclick="closeSidebarMobile()">
                    <i class="fas fa-box"></i><span>Produk</span>
                </a>
            </div>
            <div class="nav-item">
                <a href="<?= BASE_URL ?>modules/pelanggan/" class="nav-link <?= isActive('', 'pelanggan') ?>"
                    onclick="closeSidebarMobile()">
                    <i class="fas fa-users"></i><span>Pelanggan</span>
                </a>
            </div>
            <div class="nav-item">
                <a href="<?= BASE_URL ?>modules/bundling/" class="nav-link <?= isActive('', 'bundling') ?>"
                    onclick="closeSidebarMobile()">
                    <i class="fas fa-layer-group"></i><span>Bundling</span>
                </a>
            </div>
            <div class="nav-item">
                <a href="<?= BASE_URL ?>modules/kupon/" class="nav-link <?= isActive('', 'kupon') ?>"
                    onclick="closeSidebarMobile()">
                    <i class="fas fa-percent"></i><span>Kupon Diskon</span>
                </a>
            </div>
        </div>
        ...
        <div class="nav-group">
            ...
            <div class="nav-item">
                <a href="<?= BASE_URL ?>modules/transaksi/" class="nav-link <?= isActive('', 'transaksi') ?>"
                    onclick="closeSidebarMobile()">
        ...
        <div class="nav-group">
            ...
            <div class="nav-item">
                <a href="<?= BASE_URL ?>modules/template/" class="nav-link <?= isActive('', 'template') ?>"
                    onclick="closeSidebarMobile()">
            ...
            <div class="nav-item">
                <a href="<?= BASE_URL ?>modules/followup/" class="nav-link <?= isActive('', 'followup') ?>"
                    onclick="closeSidebarMobile()">
        ...
        <div class="nav-group">
            ...
            <div class="nav-item">
                <a href="<?= BASE_URL ?>modules/rekening/" class="nav-link <?= isActive('', 'rekening') ?>"
                    onclick="closeSidebarMobile()">
