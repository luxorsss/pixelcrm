        ...
        <div class="register-container">
            <div class="register-card">
                <div class="register-header">
                    ...
                    <p class="mb-0 mt-2 opacity-75">Buat akun baru untuk akses dashboard</p>
                </div>
                    ...
                    <form method="POST" id="registerForm">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="username" name="username" 
                                   value="<?= post('username') ?>" placeholder="Pilih username unik" 
    ...
    <script>
        ...
        document.getElementById('password').addEventListener('input', function() {
            ...
            if (password.length < 6) {
                strengthDiv.innerHTML = '<i class="fas fa-times me-1"></i>Password terlalu pendek';
                strengthDiv.className = 'password-strength strength-weak';
            } else if (password.length < 8) {
                strengthDiv.innerHTML = '<i class="fas fa-check me-1"></i>Password cukup kuat';
        ...
        document.getElementById('confirm_password').addEventListener('input', function() {
            ...
            if (confirmPassword === '') {
                ...
                matchDiv.innerHTML = '<i class="fas fa-check-circle me-1"></i>Password cocok';
                matchDiv.className = 'password-strength strength-strong';
            } else {
                matchDiv.innerHTML = '<i class="fas fa-times me-1"></i>Password tidak cocok';
